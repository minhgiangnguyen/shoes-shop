                    ...
                    <form class="row contact_form" action="{{route('save_checkout')}}" method="post"
                        ...
                        <div class="col-md-12 form-group p_star">
                            <input type="text" class="form-control" value="{{auth()->user()->name}}"
                                name="shipping_name" placeholder="Full Name">
                            <span style="color:red">@error('shipping_name'){{ $message }}@enderror</span>
                        </div>
                        <div class="col-md-6 form-group p_star">
                            <input type="text" class="form-control" value="{{auth()->user()->UserPhone}}"
                                name="shipping_phone" placeholder="Phone number">
                                <span style="color:red">@error('shipping_phone'){{ $message }}@enderror</span>
                        </div>
                        <div class="col-md-6 form-group p_star">
                            <input type="text" class="form-control" value="{{auth()->user()->email}}"
                                name="shipping_email" placeholder="Email Address">
                                <span style="color:red">@error('shipping_email'){{ $message }}@enderror</span>

                        </div>
                        <div class="col-md-12 form-group p_star">
                            <input type="text" class="form-control" value="{{auth()->user()->UserAddress}}"
                                name="shipping_address" placeholder="Address">
                                <span style="color:red">@error('shipping_address'){{ $message }}@enderror</span>

                        </div>
                        <div class="col-md-12 form-group p_star">
                            <input type="text" class="form-control" value="{{auth()->user()->UserCity}}"
                                name="shipping_city" placeholder="Town/City">
